...
public class Results extends JFrame 
{
	...
	{	
		...
		JLabel finalresult = new JLabel("<html>Forum is:<html>"+result+"<html><br>Total Right Answers: <html>"+result+"<html><br>Total Wrong Answers: <html>"+wrong);
		...
		label2.setText("CODED BY  aait students");
